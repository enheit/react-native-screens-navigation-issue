...
function Tab2() {
  return (
    <NestedStack.Navigator initialRouteName='Screen4' >
      <NestedStack.Screen name='Screen4' options={{ headerShown: false }} component={Screen4} />
...
function Screen2(props: any) {
  ...
  return (
    <View style={{ marginTop: insets.top }}>
      <TouchableOpacity style={buttonStyle} onPress={() => props.navigation.push('Screen3')}>
...
function Screen4(props: any) {
  ...
  return (
    <View style={{ marginTop: insets.top }}>
      ...
      <TouchableOpacity style={buttonStyle} onPress={() => props.navigation.navigate('Screen2')}>
        <Text>I am Screen4, Navigate to Screen2</Text>
      </TouchableOpacity>
      {/* Click this button at the end of the flow */}
      <TouchableOpacity style={buttonStyle} onPress={() => props.navigation.navigate('Screen5')}>
        <Text>I am Screen4, Navigate to Screen5 (click it after reproducing issue)</Text>
      </TouchableOpacity>
    </View>
  )
}
